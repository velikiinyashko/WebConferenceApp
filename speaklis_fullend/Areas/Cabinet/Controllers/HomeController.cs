...
using speaklis_fullend.Areas.Cabinet.ViewModels;
...
namespace speaklis_fullend.Areas.cabinet.Controllers
{
    [Area("cabinet")]
    public class HomeController : Controller
    {
        ...
        {
            //_context.GetService<ILoggerFactory>().AddProvider(new MyLoggerEf());
